...
def menu_figuras():
    ...
    match opcion:
        case 1:
            ...
            print(f"Área del rectángulo: {figuras.area_rectangulo(base, altura)}")
        case 2:
            base = float(input("Base: "))
            altura = float(input("Altura: "))

            print(f"Área del triángulo: {figuras.area_triangulo(base, altura)}")
        case 3:
            radio = float(input("Radio: "))
            print(f"Área del círculo: {figuras.area_circulo(radio)}")
...
def menu_conversiones():
    ...
    match opcion:
        case 1:
            ...
            print(f"Binario: {conversiones.a_binario(numero)}")
        case 2:
            numero = int(input("Introduce un número entero: "))
            print(f"Hexadecimal: {conversiones.a_hexadecimal(numero)}")
        case 3:
            texto = input("Introduce una cadena numérica: ")
            print(f"Entero: {conversiones.a_entero(texto)}")
